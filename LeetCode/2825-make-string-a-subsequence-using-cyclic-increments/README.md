...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/make-string-a-subsequence-using-cyclic-increments/)
...
**My Solution:** [2825-Make-String-a-Subsequence-Using-Cyclic-Increments.java](./2825-Make-String-a-Subsequence-Using-Cyclic-Increments.java)
